...
* Right click the link below and click "Download Linked File As..." to download the 5.32 GB cleaned Transaction data  
https://s3.us-west-2.amazonaws.com/rext-data512-final-project/ParkingTransaction_20120101_20170930_cleaned.csv
* Save the file to the `data/` directory within your cloned repository
